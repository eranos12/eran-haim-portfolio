          ...
          {filteredProjects.map((project, index) => {
            ...
            return (
              ...
              >
                  ...
                  <div className="flex-grow">
                    ...
                    <div className="mb-4">
                      <div className="flex items-start justify-between mb-3">
                        <h3 className="text-xl font-bold text-white group-hover:text-darkBlue-400 transition-colors duration-300">
                          {project.title}
                        </h3>
                  ...
                  {project.link && (
                    <div className="mt-4">
                      <a
                        ...
                        className="group/btn w-full px-4 py-3 bg-gradient-to-r from-darkBlue-500 to-blue-600 text-white text-sm font-medium rounded-lg text-center hover:shadow-lg hover:shadow-darkBlue-500/25 transition-all duration-300 hover:scale-105 transform flex items-center justify-center space-x-2"
                      >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-darkBlue-500/5 to-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
